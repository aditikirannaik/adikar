...
.form-area {
 ...
 <h2>MONTHS</h2>
  <div class="col-xs-4 box" style="height:200px;">   
    <div class="container">
...
<div class="col-xs-8 box"  style="height:500px;">
<?php
...
$sql1="SELECT leave_type, january FROM row_data";
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Year', 'no_of leaves in january'],
<?php
 if($result->num_rows > 0){
          while($row = $result->fetch_assoc()){
            echo "['".$row['leave_type']."', ".$row['january']."],";
          }
      }
...
<br>
  <body>
    ...
    <div class="col-xs-12 line"><hr></div><br>
