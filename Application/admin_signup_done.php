<html>
  ...
  <head>
    <title> Admin Login | DIGISOL GOA </title>
  </head>
...
$query = "INSERT into admin_hr(fullname,username,email,contact,address,password) VALUES('" . $fullname . "','" . $username . "','" . $email . "','" . $contact . "','" . $address ."','" . $password ."')";
