...
.form-area {
  ...
  <div class="list-group"  style="width: 500px;">
    <a href="row.php" class="list-group-item"><strong>JANUARY</strong></a>
    <a href="row2.php" class="list-group-item"><strong>FEBRUARY</strong></a>
    <a href="row3.php" class="list-group-item"><strong>MARCH</strong></a>
    <a href="row4.php" class="list-group-item"><strong>APRIL</strong></a>
    <a href="row5.php" class="list-group-item"><strong>MAY</strong></a>
    <a href="row6.php" class="list-group-item"><strong>JUNE</strong></a>
  </div>
</div>
